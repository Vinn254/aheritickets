...
function DeviceForm({ formData, setFormData, editing, handleSubmit, setEditing, pops, aps }) {
  ...
  return (
    <div>
      ...
      <form onSubmit={(e) => handleSubmit(e, deviceType + 's')} style={{ marginBottom: 15 }}>
        {renderForm()}
  ...
  return (
    <div style={{ overflowX: 'auto', WebkitOverflowScrolling: 'touch' }}>
      <table style={tableStyle}>
        <thead>
          <tr>
            <th style={{ ...thStyle, whiteSpace: 'nowrap', minWidth: isMobile ? '60px' : '80px' }}>Type</th>
            <th style={{ ...thStyle, whiteSpace: 'nowrap', minWidth: isMobile ? '100px' : '150px' }}>Name</th>
            <th style={{ ...thStyle, whiteSpace: 'nowrap', minWidth: isMobile ? '100px' : '120px' }}>IP Address</th>
            <th style={{ ...thStyle, whiteSpace: 'nowrap', minWidth: isMobile ? '120px' : '140px' }}>MAC Address</th>
            <th style={{ ...thStyle, whiteSpace: 'nowrap', minWidth: isMobile ? '100px' : '120px' }}>Brand/Model</th>
            <th style={{ ...thStyle, whiteSpace: 'nowrap', minWidth: isMobile ? '120px' : '140px' }}>Actions</th>
          </tr>
        </thead>
        <tbody>
        {pops.map(pop => (
